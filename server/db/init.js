...
const products = [
  // Caméras
  { slug:'cameras',      nom:'Caméra Solaire 4G',            prix:45000, stock:10, description:'Caméra solaire autonome, connexion 4G, vision nocturne',                    image:PLACEHOLDER('Cam Solaire') },
...
const defaultSettings = [
  ...
  ['contact_email',  'contact@atlsarl.cm'],
  ['contact_city',   'Yaoundé, Cameroun'],
